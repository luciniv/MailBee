...
class Profiles(commands.Cog):
    ...
    async def profile(self, interaction: discord.Interaction, user: discord.Member = None):
        try:
            ...
            if ap is None:
                errorEmbed = discord.Embed(description="❌ The user you selected does not currently have an anonymous profile.",
                ...
                profileEmbed.set_author(name=f"{user.name} | {user.id}", icon_url=(user.avatar and user.avatar.url) or user.display_avatar.url)
